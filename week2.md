...
다이어그램이나 표가 실제로 이해에 수월했다는 피드백을 받을 수 있었다. “구조가 한 눈에 들어와서 좋다” 같은 피드백을 들으면서 내가 작업한 정리 방식이 실제로 협업에 많은 도움이 될 수 있겠다고 느꼈다.

<br/>

### 다음에 개선하면 좋을 점

- README.md 가독성을 위해서 프롬프트를 작성할 때 “누가 이 문서를 볼 것인지”에 대한 대상 정의가 필요해보인다.
- 현재 퀘스트 내용은 “**README.md 가독성 향상 시켜보기”** 인데 개선 목표를 더 명확히 정의하면 어떨까 싶다.
